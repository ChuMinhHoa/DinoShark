...
namespace SDK {
    ...
    public class AdsManager : MonoBehaviour {
        ...
        private double m_InterstitialCappingAdsCooldown = 180;
        private double m_MaxInterstitialCappingAdsTime = 180;
        ...
        private void Awake() {
            ...
            m_InterstitialCappingAdsCooldown = 180;
            m_MaxInterstitialCappingAdsTime = 180;
        IsActiveInterruptReward = true;
#if UNITY_EDITOR
            IsActiveBannerAds = true;
#endif
            //SetFirstInstallCap(ProfileManager.PlayerData.timeManager.dayInGame == 1 ? 600 : 0);
        }
        private void Start() {
        ...
        private void Update() {
            ...
            {
                if(ProfileManager.Instance.playerData.currentLevel == 0)
                {
                    return;
                }
            }
        ...
        public void RequestInterstitial() {
            if (GetSelectedInterstitialMediation().IsInterstitialLoaded())
            {
                Debug.Log("Loaded");
                return;
            }
